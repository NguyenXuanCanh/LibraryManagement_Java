...
public class GuiPunlish{
    ...
    protected BusPunlish bus = new BusPunlish();
    ...
    public void creatMenu(MyFrame frame) {
        frame.panelContent.add(frame.interfacePunlish.panel);
    ...
    public void gui() {
        ...
        JLabel lbName = new JLabel("Punlish");
...
//		btnAdd,btnUpdate,btnDelete,btnChoose
        ...
        String colum[] = {"ID Punlish","Name Punlish"};
        ...
        btnAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(inputID.getText().equals("") == false) {
                    JOptionPane.showMessageDialog(inputName, "ID Punlish Must Blank");
                    return;
                }

                if(inputName.getText().equals("") == true) {
                    JOptionPane.showMessageDialog(inputName, "Name Punlish Blank");
                    return;
                }
        ...
        btnDelete.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if(inputID.getText().equals("") == true) {
                    JOptionPane.showMessageDialog(inputName, "ID Punlish Blank");
                    return;
                }
